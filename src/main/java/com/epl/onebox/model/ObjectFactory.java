 ...
 * generated in the com.epl.onebox.model package. 
...
public class ObjectFactory {
    ...
    private final static QName _ShortDescription_QNAME = new QName("http://www.oneboxtm.es/ns/data-query/event", "shortDescription");
    ...
    private final static QName _Subtitle_QNAME = new QName("http://www.oneboxtm.es/ns/data-query/event", "subtitle");
    ...
    private final static QName _LongDescription_QNAME = new QName("http://www.oneboxtm.es/ns/data-query/event", "longDescription");
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.epl.onebox.model
     * 
     */
    ...
    /**
     * Create an instance of {@link BasicInfoSessionSearchInfo }
     * 
     */
    public BasicInfoSessionSearchInfo createBasicInfoSessionSearchInfo() {
        return new BasicInfoSessionSearchInfo();
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.oneboxtm.es/ns/data-query/event", name = "shortDescription")
    ...
    /**
     * Create an instance of {@link SpaceCode }}
     * 
     */
    @XmlElementDecl(namespace = "http://www.oneboxtm.es/ns/data-query/prices", name = "code")
    public SpaceCode createSpaceCode(String value) {
        return new SpaceCode(value);
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.oneboxtm.es/ns/data-query/event", name = "subtitle")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.oneboxtm.es/ns/data-query/event", name = "longDescription")
    ...
    public TicketType createTicketType(String value) {
