 ...
 *         &lt;element ref="{http://www.oneboxtm.es/ns/data-query/session}sessions-search-info"/>
 *       &lt;/sequence>
...
public class EventSearchInfo {
    ...
    @XmlElement(name = "sessions-search-info", namespace = "http://www.oneboxtm.es/ns/data-query/session", required = true)
    ...
    /**
     * Obtiene el valor de la propiedad sessionsSearchInfo.
     * 
     * @return
     *     possible object is
    ...
    /**
     * Define el valor de la propiedad sessionsSearchInfo.
     * 
     * @param value
     *     allowed object is
     *     {@link SessionsSearchInfo }
